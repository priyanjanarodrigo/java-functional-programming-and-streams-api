package com.myorg.functionalProgramming.declarative.optionals;
...
public class OptionalBasics {
    ...
    public static void optionalExample7_or() {
        ...
        Integer value = intgerOptional
                ...
                .or(()->{
                    // We can include additional computation here when constructing the Optional if required
    ...
    public static void main(String[] args) {
        ...
        OptionalBasics.emptyOptionalExampleWithMethods();

        System.out.println("\noptionalExample2()\n");
        OptionalBasics.optionalExample2();

        System.out.println("\noptionalExample3_orElse\n");
        OptionalBasics.optionalExample3_orElse();

        // CallbacksDemo.nullPointerExceptionScenario() // Throws a NullPointerException

        System.out.println("\noptionalExample4_ofNullable\n");
        OptionalBasics.optionalExample4_ofNullable();

        System.out.println("\noptionalExample5\n");
        OptionalBasics.optionalExample5();

        System.out.println("\noptionalExample6_orElseGet\n");
        OptionalBasics.optionalExample6_orElseGet();

        System.out.println("\noptionalExample7_or\n");
        OptionalBasics.optionalExample7_or();

        // System.out.println("\noptionalExample8_orElseThrow\n");
        // CallbacksDemo.optionalExample8_orElseThrow(); // will throw NoSuchElementException

        // System.out.println("\noptionalExample9_orElseThrow_ExceptionManually\n");
        // CallbacksDemo.optionalExample9_orElseThrow_ExceptionManually(); // will throw specified IllegalStateException

        System.out.println("\noptionalExample10_ifPresent\n");
        OptionalBasics.optionalExample10_ifPresent();

        System.out.println("\noptionalExample11_ifPresentOrElse\n");
        OptionalBasics.optionalExample11_ifPresentOrElse();
    }
}
